...
export class SupportTicketNotFoundError extends DomainError {
  constructor(id: string) {
    super(`Support ticket not found: ${id}`, 'SUPPORT_TICKET_NOT_FOUND');
    this.name = 'SupportTicketNotFoundError';
  }
}

export class SupportTicketMessageNotFoundError extends DomainError {
  constructor(id: string) {
    super(`Support ticket message not found: ${id}`, 'SUPPORT_TICKET_MESSAGE_NOT_FOUND');
    this.name = 'SupportTicketMessageNotFoundError';
  }
}
