...
import { shipmentStatusEnum, shippingDocumentTypeEnum } from './common';
...
export const shipments = pgTable('shipments', {
  ...
  originPortId: uuid('origin_port_id').references(() => ports.id, { onDelete: 'set null' }),
  destinationPortId: uuid('destination_port_id').references(() => ports.id, { onDelete: 'set null' }),
  ...
  vesselIdx: index('shipments_vessel_idx').on(table.vessel),
  bookingIdx: index('shipments_booking_idx').on(table.bookingReference),
}));
...
export const shippingDocuments = pgTable('shipping_documents', {
  ...
  documentType: shippingDocumentTypeEnum('document_type').default('other'),
