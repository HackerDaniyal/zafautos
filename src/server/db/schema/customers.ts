...
export const customers = pgTable('customers', {
  ...
  userIdUniqueIdx: uniqueIndex('customers_user_id_unique_idx').on(table.userId),
}));
...
export const customerWishlist = pgTable('customer_wishlist', {
  ...
  customerVehicleUniqueIdx: uniqueIndex('customer_wishlist_customer_vehicle_unique_idx').on(table.customerId, table.vehicleId),
}));
