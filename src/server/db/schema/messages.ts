...
import { notificationCategoryEnum, notificationStatusEnum } from './common';
...
export const notifications = pgTable('notifications', {
  ...
  eventKeyIdx: index('notifications_event_key_idx').on(table.eventKey),
}));
...
export const notificationPreferences = pgTable('notification_preferences', {
  ...
  userCategoryIdx: uniqueIndex('notification_preferences_user_category_idx').on(table.userId, table.category),
}));
