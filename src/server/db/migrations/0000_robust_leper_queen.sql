...
CREATE TYPE "public"."user_role_enum" AS ENUM('customer', 'dealer', 'admin', 'super_admin');--> statement-breakpoint
...
ALTER TABLE "profiles" ADD CONSTRAINT "profiles_language_id_languages_id_fk" FOREIGN KEY ("language_id") REFERENCES "public"."languages"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "featured_vehicles" ADD CONSTRAINT "featured_vehicles_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "featured_vehicles" ADD CONSTRAINT "featured_vehicles_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "featured_vehicles" ADD CONSTRAINT "featured_vehicles_deleted_by_users_id_fk" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicle_compare" ADD CONSTRAINT "vehicle_compare_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_compare" ADD CONSTRAINT "vehicle_compare_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_compare" ADD CONSTRAINT "vehicle_compare_deleted_by_users_id_fk" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicle_enquiries" ADD CONSTRAINT "vehicle_enquiries_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_enquiries" ADD CONSTRAINT "vehicle_enquiries_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_enquiries" ADD CONSTRAINT "vehicle_enquiries_deleted_by_users_id_fk" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicle_views" ADD CONSTRAINT "vehicle_views_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_views" ADD CONSTRAINT "vehicle_views_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_views" ADD CONSTRAINT "vehicle_views_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_views" ADD CONSTRAINT "vehicle_views_deleted_by_users_id_fk" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicle_wishlist" ADD CONSTRAINT "vehicle_wishlist_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_wishlist" ADD CONSTRAINT "vehicle_wishlist_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_wishlist" ADD CONSTRAINT "vehicle_wishlist_deleted_by_users_id_fk" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_thread_id_message_threads_id_fk" FOREIGN KEY ("thread_id") REFERENCES "public"."message_threads"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "orders" ADD CONSTRAINT "orders_dealer_id_dealers_id_fk" FOREIGN KEY ("dealer_id") REFERENCES "public"."dealers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "manufacturers" ADD CONSTRAINT "manufacturers_country_id_countries_id_fk" FOREIGN KEY ("country_id") REFERENCES "public"."countries"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_body_type_id_body_types_id_fk" FOREIGN KEY ("body_type_id") REFERENCES "public"."body_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_fuel_type_id_fuel_types_id_fk" FOREIGN KEY ("fuel_type_id") REFERENCES "public"."fuel_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_transmission_id_transmissions_id_fk" FOREIGN KEY ("transmission_id") REFERENCES "public"."transmissions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_drive_type_id_drive_types_id_fk" FOREIGN KEY ("drive_type_id") REFERENCES "public"."drive_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_color_id_colors_id_fk" FOREIGN KEY ("color_id") REFERENCES "public"."colors"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_currency_id_currencies_id_fk" FOREIGN KEY ("currency_id") REFERENCES "public"."currencies"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_port_id_ports_id_fk" FOREIGN KEY ("port_id") REFERENCES "public"."ports"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "customer_wishlist_customer_vehicle_idx" ON "customer_wishlist" USING btree ("customer_id","vehicle_id");--> statement-breakpoint
...
CREATE INDEX "dealer_assignments_dealer_order_idx" ON "dealer_assignments" USING btree ("dealer_id","order_id");--> statement-breakpoint
...
CREATE INDEX "vehicle_compare_user_vehicle_idx" ON "vehicle_compare" USING btree ("user_id","vehicle_id");--> statement-breakpoint
...
CREATE INDEX "vehicle_views_vehicle_idx" ON "vehicle_views" USING btree ("vehicle_id");--> statement-breakpoint
CREATE INDEX "vehicle_views_user_idx" ON "vehicle_views" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "vehicle_wishlist_user_vehicle_idx" ON "vehicle_wishlist" USING btree ("user_id","vehicle_id");--> statement-breakpoint
...
CREATE INDEX "order_items_order_vehicle_idx" ON "order_items" USING btree ("order_id","vehicle_id");--> statement-breakpoint
...
CREATE INDEX "vehicles_country_idx" ON "vehicles" USING btree ("country_id");--> statement-breakpoint
...
CREATE INDEX "vehicles_transmission_idx" ON "vehicles" USING btree ("transmission_id");--> statement-breakpoint
CREATE INDEX "vehicles_drive_type_idx" ON "vehicles" USING btree ("drive_type_id");--> statement-breakpoint
CREATE INDEX "vehicles_color_idx" ON "vehicles" USING btree ("color_id");--> statement-breakpoint
...
CREATE INDEX "vehicles_currency_idx" ON "vehicles" USING btree ("currency_id");--> statement-breakpoint
CREATE INDEX "vehicles_port_idx" ON "vehicles" USING btree ("port_id");