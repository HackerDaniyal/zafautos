...
import { LayoutDashboard, Car, ShoppingBag, Users, BarChart3, Settings, LogOut, Menu, X } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/dealer/vehicles', label: 'Inventory', icon: Car },
  { href: '/dealer/orders', label: 'Orders', icon: ShoppingBag },
