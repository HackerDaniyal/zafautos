...
import { addOrderNote, deleteOrderNote } from '@/server/actions/orderActions';
...
export function OrderNotes({ orderId, notes, onNotesChanged }: OrderNotesProps) {
  ...
  async function handleAddNote() {
    ...
    setAdding(true);
    try {
      const result = await addOrderNote(orderId, newNote.trim());
      if (result.success) {
