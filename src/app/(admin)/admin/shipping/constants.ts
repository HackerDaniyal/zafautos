...
export const SHIPMENT_STATUS_CONFIG: Record<ShipmentStatus, { label: string; color: string; bgColor: string; dotColor: string }> = {
  ...
  booked: { label: 'Booked', color: 'text-blue-300', bgColor: 'bg-blue-300/10', dotColor: 'bg-blue-300' },
  picked_up: { label: 'Picked Up', color: 'text-cyan-400', bgColor: 'bg-cyan-400/10', dotColor: 'bg-cyan-400' },
  in_transit: { label: 'In Transit', color: 'text-blue-400', bgColor: 'bg-blue-400/10', dotColor: 'bg-blue-400' },
  arrived: { label: 'Arrived', color: 'text-emerald-400', bgColor: 'bg-emerald-400/10', dotColor: 'bg-emerald-400' },
  ...
  exception: { label: 'Exception', color: 'text-signal-red', bgColor: 'bg-signal-red/10', dotColor: 'bg-signal-red' },
