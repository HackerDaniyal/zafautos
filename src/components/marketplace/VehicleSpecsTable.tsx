...
export function VehicleSpecsTable({ specs, className }: VehicleSpecsTableProps) {
  ...
  return (
    <section className={cn('rounded-[10px] border border-gray-200 bg-white p-4', className)}>
      <h2 className="font-[Oswald] text-base font-bold uppercase tracking-wider text-gray-900 mb-2">Vehicle Specifications</h2>
