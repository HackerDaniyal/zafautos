  ...
  return (
    <section className={cn('space-y-4', className)}>
      ...
      <div className="flex items-center justify-between">
        <h2 className="font-[Oswald] text-base font-bold uppercase tracking-wider text-gray-900">{title}</h2>
        <Button variant="ghost" size="sm" asChild className="text-xs text-gray-500 hover:text-gray-900 hover:bg-transparent">
